...
--PROCEDIMIENTO ALMACENADO PARA EL CALCULO DEL INTERES DIARIO
...
BEGIN
	BEGIN TRY 
        BEGIN TRANSACTION;
			...
			--INSERTA REGISTROS EN TABLA TEMPORAL DE LAS CUENTAS QUE SU MONTO SE ENCUENTRA DENTRO DEL RANGO DE MAXIMOS Y MINIMOS DE LA TABLA TBL_TASA
			...
			--ACTUALIZA EL SALDO DE LOS REGISTROS ENCONTRADOS
			UPDATE 
				CB
			SET 
			...
			--INSERTA LOS REGISTROS ACTUALIZADOS EN LA TABLA HISTORICO
...
BEGIN
    BEGIN TRY 
        ...
        BEGIN
	    --ACTUALIZA EL SALDO DE LA CUENTA BANCARIA SELECCIONADA
            UPDATE TBL_CUENTA_BANCARIA
            SET SALDO = SALDO + @P_MONTO
            WHERE PK_TBL_CUENTA_BANCARIA = @P_PK_TBL_CUENTA_BANCARIA;

	    --INSERTA UN REGISTRO DE LA TRANSACCION DE DEPOSITO REALIZADA ANTERIORMENTE
	    ...
	    --INSERTA UN REGISTRO DE LA TRANSACCION DE RETIRO REALIZADA ANTERIORMENTE
	    INSERT INTO TBL_TRANSACCION(FK_PK_TBL_CUENTA_BANCARIA, FK_PK_TBL_TIPO_TRANSACCION, MONTO, FECHA)
	    VALUES (@P_PK_TBL_CUENTA_BANCARIA, @P_PK_TBL_TIPO_TRANSACCION, @P_MONTO, GETDATE())
        END;
	    ...
	    --ACTUALIZA EL SALDO DE LA CUENTA BANCARIA ORIGEN SELECCIONADA
            UPDATE TBL_CUENTA_BANCARIA
            SET SALDO = SALDO - @P_MONTO
            WHERE PK_TBL_CUENTA_BANCARIA = @P_PK_TBL_CUENTA_BANCARIA;

            --ACTUALIZA EL SALDO DE LA CUENTA BANCARIA DESTINO SELECCIONADA
            UPDATE TBL_CUENTA_BANCARIA
            SET SALDO = SALDO + @P_MONTO
            WHERE PK_TBL_CUENTA_BANCARIA = @P_PK_TBL_CUENTA_BANCARIA_DESTINO;

	    --INSERTA UN REGISTRO DE LA TRANSACCION DE TRASPASO REALIZADA ANTERIORMENTE
